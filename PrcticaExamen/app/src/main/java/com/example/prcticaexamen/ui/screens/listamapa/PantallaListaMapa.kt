...
@Composable
fun PantallaListaMapas(
    viewModel: PantallaListaMapaViewModel = hiltViewModel(),
    ...
    LaunchedEffect(Unit) {
        viewModel.handleEvent(PantallaListaMapaEvent.GetMapas)
    }

    PantallaListaMapasInterna(
        //navController = navController,
        state = state.value,
        onViewDetalle = onViewDetalle,
        onDelete = {viewModel.handleEvent(PantallaListaMapaEvent.DeletePersonaje(1))},
...
@Composable
fun PantallaListaMapasInterna(
    //navController: NavController,
    state: PantallaListaMapaState,
    onViewDetalle: (Int) -> Unit,
    onDelete: (Int) -> Unit,
    bottomNavigationBar: @Composable () -> Unit = {},
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            items(items = state.mapas, key = { persona -> persona.id }) { personaje ->
...
fun MapaItem(
    ...
    Card(modifier = modifier
        .fillMaxWidth()
        .padding(8.dp)
        .clickable { onViewDetalle(mapa.id) }) {
