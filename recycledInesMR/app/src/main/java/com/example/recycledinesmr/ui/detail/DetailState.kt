...
data class DetailState(
    val pelicula: Pelicula = Pelicula(titulo = Constantes.VACIO, director = Constantes.VACIO, fecha = null, estrellas = 0.00f, clasificacionEdad = Constantes.VACIO, imagen = Constantes.VACIO),
